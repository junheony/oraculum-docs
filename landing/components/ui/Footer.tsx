      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-400 max-w-md mb-6">
              Where markets reveal truth. The next generation prediction market powered by
              collective intelligence and AI signal analysis.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {['Features', 'How it Works', 'AI Signals', 'Roadmap', 'Documentation'].map((link) => (
                <li key={link}>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {['FAQ', 'Community', 'Support', 'Terms of Service', 'Privacy Policy'].map((link) => (
                <li key={link}>
                  <a href="#" className="text-gray-400 hover:text-white transition-colors text-sm">
                    {link}
                  </a>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-gray-500 text-sm">
            2024 Oraculum. All rights reserved.
          </p>
          <p className="text-gray-500 text-sm">
