...
const fragmentShader = `
  ...
  void main() {
    ...
    float noise2 = snoise(vPosition * 4.0 - uTime * 0.2);
    float noise3 = snoise(vPosition * 1.0 + uTime * 0.1);
    ...
    // Inner glow
    float innerGlow = pow(1.0 - length(vUv - 0.5) * 1.5, 2.0);
    color += uColor1 * innerGlow * 0.3;
...
export default function GlowingOrb({ position = [0, 0, 0], scale = 1.5 }: GlowingOrbProps) {
